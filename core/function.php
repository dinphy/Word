...
function _GetCatalog()
{
	...
	if ($catalog) {
		...
		$index = '<div class="tree"><div class="title">文章目录</div><div class="contain">' . $index . '<svg class="toc-marker" xmlns="http://www.w3.org/2000/svg"><path stroke="var(--theme)" stroke-width="3" fill="transparent" stroke-dasharray="0, 0, 0, 1000" stroke-linecap="round" stroke-linejoin="round" transform="translate(-0.5, -0.5)" /></svg></div></div>';
	}
	echo $index;
}
