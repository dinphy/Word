...
?>
        ...
        <script src="<?php Helper::options()->themeUrl('typecho/write/js/joe.write.chunk.js?v=20210530') ?>"></script>
        <script src="<?php Helper::options()->themeUrl('assets/js/joe.short.min.js?v=20210529') ?>"></script>
<?php
    }
}
