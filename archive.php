                                    ...
                                    <li class="joe_list__item wow chat">
                                        <div class="information">
                                            ...
                                            <div class="desc">
                                                ...
                                                <div class="time"><?php $this->date('Y年m月d日 H:i:s A'); ?></div>
                                            </div>
                                        </div>
                                        <div class="content">
                                            <div class="abstract"><?php _getAbstract($this) ?></div>
                                            <a class="title" href="<?php $this->permalink() ?>" target="_blank" rel="noopener noreferrer">#<?php $this->title() ?></a>
                                        </div>
                                        <div class="meta">
                                            <div class="meta-left">
                                                <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="15" height="15">
                                                    ...
                                                    <path d="M871.563 515.449L511.81 671.775 152.358 515.787v73.578a34.248 34.248 0 0 0 20.76 31.48l301.518 129.19c11.806 5.703 24.499 8.546 37.175 8.546s25.367-2.843 37.174-8.546L850.82 620.534a34.248 34.248 0 0 0 20.744-31.474V515.45z" fill="#ff6a18" />
                                                </svg>
                                                <?php if (sizeof($this->categories) > 0) : ?>
                                                    <?php foreach (array_slice($this->categories, 0, 5) as $key => $item) : ?>
                                                        <a class="link" target="_blank" rel="noopener noreferrer" href="${_.category.length && _.category[0].permalink}"><?php echo $item['name']; ?></a>
                                                    <?php endforeach; ?>
                                                <?php endif; ?>
                                            </div>
