...
<head>
	...
	<link rel="stylesheet" href="<?php $this->options->themeUrl('library/css/swiper.min.css'); ?>">
	<script src="<?php $this->options->themeUrl('library/js/swiper.min.js'); ?>"></script>
	<script src="<?php $this->options->themeUrl('library/js/wow.min.js'); ?>"></script>
