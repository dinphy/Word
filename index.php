...
<head>
	...
	<link rel="stylesheet" href="<?php $this->options->themeUrl('assets/css/joe.index.min.css?v=7.3.6.3'); ?>">
	<script src="<?php $this->options->themeUrl('assets/js/joe.index.min.js?v=7.3.6.5'); ?>"></script>
</head>
