<aside class="joe_aside">
    <?php if ($this->options->JAside_Author_Status === 'on') : ?>
        <section class="joe_aside__item author">
            <img width="100%" height="120" class="image lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="<?php $this->options->JAside_Author_Image ? $this->options->JAside_Author_Image() : $this->options->themeUrl('assets/img/aside_author_image.jpg') ?>" alt="博主栏壁纸" />
            <div class="user">
