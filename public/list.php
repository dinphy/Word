<div class="<?php $this->is('category') ? 'joe_archive' : '' ?>">
    <?php if ($this->have()) : ?>
                ...
                <?php elseif ($this->fields->mode === "chat") : ?>
                    <li class="joe_list__item wow chat">
                        <div class="information">
                            ...
                            <div class="desc">
                                <div class="author">
                                    <a href="<?php $this->author->permalink(); ?>" target="_blank" rel="noopener noreferrer"><?php $this->author(); ?></a>
                                </div>
                                <div class="content">
