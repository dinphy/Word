document.addEventListener('DOMContentLoaded', function () {
	...
	if (
		(e.forEach(function (o) {
			o.addEventListener('click', function () {
				...
				sessionStorage.setItem('joe_config_current', c),
					'joe_notice' === c ? ((t.style.display = 'block'), (s.style.display = 'none')) : ((t.style.display = 'none'), (s.style.display = 'block')),
		...
		'joe_notice' === o ? ((t.style.display = 'block'), (s.style.display = 'none')) : ((s.style.display = 'block'), (t.style.display = 'none')),
			e.forEach(function (e) {
